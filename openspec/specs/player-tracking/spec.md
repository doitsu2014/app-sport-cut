# player-tracking Specification

## Purpose
Time-stamped player identity, calibrated court positions, side assignments, coverage, and a versioned `tracks/player_tracks.json` artifact for downstream rally analysis.
